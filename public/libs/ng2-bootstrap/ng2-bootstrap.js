...
System.registerDynamic("ng2-bootstrap/components/collapse/collapse.component", ["angular2/core", "angular2/src/animate/animation_builder"], true, function($__require, exports, module) {
  ...
  var Collapse = (function() {
    ...
    Collapse = __decorate([core_1.Directive({selector: '[collapse]'}), __metadata('design:paramtypes', [animation_builder_1.AnimationBuilder, core_1.ElementRef, core_1.Renderer])], Collapse);
    return Collapse;
  }());
...
System.registerDynamic("ng2-bootstrap/components/datepicker/datepicker-popup", ["angular2/core", "angular2/common", "../position", "./datepicker"], true, function($__require, exports, module) {
  ...
  var DatePickerPopup = (function() {
    ...
    DatePickerPopup.prototype.show = function(cb) {
      ...
      this.popup = this.loader.loadNextToLocation(PopupContainer, this.viewContainerRef, binding).then(function(componentRef) {
    ...
    }), __param(0, core_1.Self()), __metadata('design:paramtypes', [common_1.NgModel, core_1.ViewContainerRef, core_1.Renderer, core_1.DynamicComponentLoader])], DatePickerPopup);
...
System.registerDynamic("ng2-bootstrap/components/tabs/tabset.component", ["angular2/core", "angular2/common", "../common"], true, function($__require, exports, module) {
  ...
  var Tabset = (function() {
    ...
    __decorate([core_1.HostBinding('class.tab-container'), __metadata('design:type', Boolean)], Tabset.prototype, "clazz", void 0);
...
System.registerDynamic("ng2-bootstrap/components/tooltip/tooltip.directive", ["angular2/core", "./tooltip-options.class", "./tooltip-container.component"], true, function($__require, exports, module) {
  ...
  var Tooltip = (function() {
    ...
    Tooltip.prototype.show = function() {
      ...
      this.tooltip = this.loader.loadNextToLocation(tooltip_container_component_1.TooltipContainer, this.viewContainerRef, binding).then(function(componentRef) {
        return componentRef;
      });
    };
    ...
    Tooltip = __decorate([core_1.Directive({selector: '[tooltip]'}), __metadata('design:paramtypes', [core_1.ViewContainerRef, core_1.DynamicComponentLoader])], Tooltip);
    return Tooltip;
  }());
...
System.registerDynamic("ng2-bootstrap/components/typeahead/typeahead.directive", ["angular2/core", "angular2/common", "./typeahead-utils", "./typeahead-container.component", "./typeahead-options.class"], true, function($__require, exports, module) {
  ...
  var Typeahead = (function() {
    ...
    Typeahead.prototype.show = function(matches) {
      ...
      this.popup = this.loader.loadNextToLocation(typeahead_container_component_1.TypeaheadContainer, this.viewContainerRef, binding).then(function(componentRef) {
    ...
    __decorate([core_1.HostListener('focus', ['$event.target']), __metadata('design:type', Function), __metadata('design:paramtypes', []), __metadata('design:returntype', void 0)], Typeahead.prototype, "onFocus", null);
    ...
    Typeahead = __decorate([core_1.Directive({selector: '[typeahead][ngModel]'}), __metadata('design:paramtypes', [common_1.NgModel, core_1.ViewContainerRef, core_1.ElementRef, core_1.Renderer, core_1.DynamicComponentLoader])], Typeahead);
    return Typeahead;
  }());
