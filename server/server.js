...
var timelog_mongoose_model_1 = require("./models/timelog.mongoose.model");
...
app.get('/api/timelogs', function (req, res) {
    timelog_mongoose_model_1.TimeLog.find(function (err, timeLogs) {
...
app.post('/api/timelogs', function (req, res) {
    ...
    timelog_mongoose_model_1.TimeLog.findOneAndUpdate({ _id: req.body._id ? req.body._id : new mongoose.mongo.ObjectID() }, {
...
app.delete('/api/timelogs/delete/:timelogId', function (req, res) {
    ...
    timelog_mongoose_model_1.TimeLog.remove({
